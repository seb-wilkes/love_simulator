...
class agent:
    ...
    def attraction_kernel(self, beauty_value_of_person):
        # This is the model for how people interact with one another        
...
class population:
    def __init__(self, random_var, size):
        '''
        random_var: is a python function, with no args, that produces 
        a variable that is distrubted with an appropriate PDF
    ...
    def compatibility_stage_first_preference(self, shuffled_indices,
        ...
        for i in range(len(shuffled_indices)):
            ...
            compatibility = compatibility_maitrx[i]*compatibility_maitrx[:,i]
